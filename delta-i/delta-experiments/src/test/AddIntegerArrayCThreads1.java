...
public class AddIntegerArrayCThreads1 {

	public static void main(String[] args) throws IOException {		
		BufferedWriter writer = new BufferedWriter(new FileWriter(Command.getLocalInfo() + "-AddIntegerThreads1.txt",true)) ;
		...
		for (; arraySize < arraySizeMax; arraySize*=10) {
			...
			for (numThreads = 1; numThreads < numThreadsMax; numThreads++) {
				...
				for (int i = 0; i < avgSize; i++) {
					...
					NativeLibrary.addIntegerArrayCThreads1(a, b, numThreads);
