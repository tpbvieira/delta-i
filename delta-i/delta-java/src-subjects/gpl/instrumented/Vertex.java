...
class Vertex implements EdgeIfc, NeighborIfc {
	...
	public void adjustAdorns(Vertex the_vertex, int index) {
		DeltaInt the_weight = the_vertex.weightsList.get(index);
	...
	public LinkedList<DeltaInt> weightsList = new LinkedList<DeltaInt>();

	public void addWeight(DeltaInt weight) {
	...
	public DeltaInt vertexNumber;

	public DeltaInt componentNumber;

	public DeltaInt finishTime;

	public DeltaInt strongComponentNumber;

	public DeltaInt VertexCycle;

	public DeltaInt VertexColor; // white ->0, gray ->1, black->2
	...
	public DeltaInt key; // weight so far from s to it

	public void display() {
		// Weights
		System.out.print(" Weights : ");
		for (int i = 0; i < weightsList.size(); i++) {
			System.out.print(weightsList.get(i) + ", ");
		}
		// all
